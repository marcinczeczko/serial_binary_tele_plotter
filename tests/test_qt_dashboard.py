...
def test_stream_tabs_show_activity_and_the_time_button_the_window(
    ...
    # The name stays; a square shows data arriving, the rate is in the tooltip (R9.2).
    ...
    assert tabs.rate("pid") is None and "no data" in tabs.tabToolTip(0)
    assert win.panel.conn_panel.pause_btn.text() == "—"
